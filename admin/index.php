...
<div class="login-box">
    <div class="login-logo">
        <a href="index.php"><b>PriceNowBd</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
<!-- Bootstrap 4 -->
<script src="../assets/admin/js/jquery/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="../assets/admin/js/plugins/adminlte.js"></script>
